...
! function (n, t) {
    ...
    function o(n) {
        var t;
        t = n.scene != fn, fn = n.scene, G = 0, K = n, $ = n.query.ald_share_src, z = n.query.aldsrc || "", F = n.query
            .ald_share_src, cn || (V = !1), cn = !1, un || (0 !== j && Date.now() - j > 3e4 ? (E = w(), T = Date.now()) :
                t && (T = Date.now(), E = w())), 0 !== j && Date.now() - j < 3e4 && (en = !0), n.query.ald_share_src &&
            "1044" == n.scene && n.shareTicket ? wx.getShareInfo({
                ...
                success: function (n) {
                    if (n.authSetting["scope.userInfo"]) {
                        wx.getUserInfo({
                            ...
                            success: function (n) {
                                var t = g();
                                Z = n, t.ufo = S(n), Q = v(n.userInfo.avatarUrl.split("/")), p(
                                    t)
                            }
                        })
                    }
    ...
    function h(n) {
        ...
        e.ald_share_src ? e.ald_share_src.indexOf(W) == -1 && e.ald_share_src.length < 200 && (e.ald_share_src = e.ald_share_src +
            "," + W) : e.ald_share_src = W;
    ...
    function p(n) {
        ...
        G++, n.at = E, n.et = Date.now(), n.uu = W, n.v = H, n.ak = I.app_key.replace(/(\t)|(\s)/g, ""), n.wsr = K,
            n.ifo = V, n.rq_c = G, n.ls = B, n.st = Date.now(), n.te = U, wx.Queue.push(t)
    }
    ...
    function x(n, t) {
        var e = g();
        e.ev = n, e.life = t, e.pp = on, e.pc = rn, e.dr = Date.now() - T, un && (e.so = 1), un = !1, an && "{}" !=
            JSON.stringify(an) && (e.ag = an), z && (e.qr = z, e.sr = z), $ && (e.usr = $), en && (e.ps = 1), tn ||
            (sn = on, tn = !0, e.ifp = tn, e.fp = on), p(e)
    }
    ...
    function q(n) {
        var t = {};
        for (var e in n) "onLoad" !== e && "onShow" !== e && "onHide" !== e && "onUnload" !== e &&
            "onPullDownRefresh" !== e && "onReachBottom" !== e && "onShareAppMessage" !== e && (t[e] = n[e]);
        return t.onLoad = function (t) {
            ...
            f(), n.onPullDownRefresh && "function" == typeof n.onPullDownRefresh && n.onPullDownRefresh.call(
                this, t)
        }, n.onShareAppMessage && "function" == typeof n.onShareAppMessage && (t.onShareAppMessage = function (
            t) {
    ...
    ! function () {
        wx.request({
            ...
            method: "GET",
            success: function (n) {
                200 === n.statusCode && (H < n.data.version && console.warn("您的SDK不是最新版本，请尽快升级！"), n.data
    ...
    try {
        ...
        nn.br = ln.brand, nn.pm = ln.model, nn.pr = ln.pixelRatio, nn.ww = ln.windowWidth, nn.wh = ln.windowHeight,
            nn.lang = ln.language, nn.wv = ln.version, nn.wvv = ln.platform, nn.wsdk = ln.SDKVersion, nn.sv = ln.system
    } catch (n) {}
    wx.getNetworkType({
        success: function (n) {
            nn.nt = n.networkType
        ...
        t.tp = "session", t.ct = "session", t.ev = "event", "" === Z ? wx.getSetting({
            success: function (n) {
                n.authSetting["scope.userInfo"] ? wx.getUserInfo({
                    success: function (n) {
                        t.ufo = S(n), Q = v(n.userInfo.avatarUrl.split("/")), "" !== Y &&
                            (t.gid = Y), p(t)
                    }
                }) : "" !== Y && (t.gid = Y, p(t))
            }
    ...
    return I.plugin ? {
        ...
        ! function () {
            ...
            App = function (t) {
                ...
                A(n, "onLoad", a), A(n, "onUnload", u), A(n, "onShow", s), A(n, "onHide", c), A(n,
                    "onReachBottom", l), A(n, "onPullDownRefresh", f), void 0 !== e && null !== e && (n
                    .onShareAppMessage = function (n) {
                        if (void 0 !== e) {
                            var t = e.call(this, n);
                            return void 0 === t ? (t = {}, t.path = on) : void 0 === t.path && (t.path =
                                on), h(t)
                        }
                    }), t(n)
                ...
                try {
                    ...
                    A(n.methods, "onLoad", a), A(n.methods, "onUnload", u), A(n.methods, "onShow", s), A(n.methods,
                        "onHide", c), A(n.methods, "onReachBottom", l), A(n.methods,
                        "onPullDownRefresh", f), void 0 !== t && null !== t && (n.methods.onShareAppMessage =
                        function (n) {
                            if (void 0 !== t) {
                                var e = t.call(this, n);
                                return void 0 === e ? (e = {}, e.path = on) : void 0 === e.path && (e.path =
                                    on), h(e)
                            }
                        }), d(n)
                } catch (t) {
