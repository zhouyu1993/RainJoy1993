...
!function (n, t) {
    "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof3.default)(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : n.Ald = t();
}(undefined, function () {
    function n() {
        this.concurrency = 4, this.queue = [], this.tasks = [], this.activeCount = 0;
        var n = this;
        this.push = function (t) {
            this.tasks.push(new _promise2.default(function (e, o) {
                var r = function r() {
            ...
            return _promise2.default.all(this.tasks);
        }, this.next = function () {
    ...
    function o(n) {
        ...
        t = n.scene != fn, fn = n.scene, G = 0, K = n, $ = n.query.ald_share_src, z = n.query.aldsrc || "", F = n.query.ald_share_src, cn || (V = !1), cn = !1, un || (0 !== j && Date.now() - j > 3e4 ? (E = w(), T = Date.now()) : t && (T = Date.now(), E = w())), 0 !== j && Date.now() - j < 3e4 && (en = !0), n.query.ald_share_src && "1044" == n.scene && n.shareTicket ? wx.getShareInfo({
            ...
            success: function success(n) {
                Y = n, D("event", "ald_share_click", (0, _stringify2.default)(n));
            }
    ...
    function h(n) {
        ...
        var t = y(n.path),
            e = {};
        for (var o in K.query) {
            "ald_share_src" === o && (e[o] = K.query[o]);
        }var r = "";
        if (r = n.path.indexOf("?") == -1 ? n.path + "?" : n.path.substr(0, n.path.indexOf("?")) + "?", "" !== t) for (var o in t) {
            e[o] = t[o];
    ...
    function _(n) {
        for (var t in n) {
            if ("object" == (0, _typeof3.default)(n[t]) && null !== n[t]) return !0;
        }return !1;
    }
    ...
    function x(n, t) {
        var e = g();
        e.ev = n, e.life = t, e.pp = on, e.pc = rn, e.dr = Date.now() - T, un && (e.so = 1), un = !1, an && "{}" != (0, _stringify2.default)(an) && (e.ag = an), z && (e.qr = z, e.sr = z), $ && (e.usr = $), en && (e.ps = 1), tn || (sn = on, tn = !0, e.ifp = tn, e.fp = on), p(e);
    }
    ...
    var I = require('./ald-stat-conf.js'),
        H = "7.2.6",
        C = "log",
        U = "wx",
        O = function () {
    ...
    wx.getNetworkType({
        ...
        if ("" !== n && "string" == typeof n && n.length <= 255) {
            if ("string" == typeof t && t.length <= 255) D("event", n, t);else if ("object" == (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t))) {
                if ((0, _stringify2.default)(t).length >= 255) return void console.error("自定义事件参数不能超过255个字符");
                if (_(t)) return void console.error("事件参数，参数内部只支持Number,String等类型，请参考接入文档");
                D("event", n, (0, _stringify2.default)(t));
